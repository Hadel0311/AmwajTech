  ...
  <div class="manage-container">
    <div class="header-actions">
      ...
      <div class="header-buttons">
        ...
        <button @click="openModal()" class="btn-primary">Add New Partner</button>
      </div>
    </div>

    <div v-if="loading" class="loading">Loading partners...</div>
    ...
    <table v-else class="data-table">
      ...
      <tbody>
        <tr v-for="(item, index) in partners" :key="item.id"
            draggable="true"
          ...
          <td>
            ...
            <img :src="'/AmwajTech/partners/' + item.logo" :alt="item.name" class="table-img" v-else />
          </td>
          <td>{{ item.name }}</td>
    ...
    <div v-if="showModal" class="modal-overlay">
      <div class="modal-content">
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="form-group">
            <label>Category (e.g. Digital Creative)</label>
          ...
          <div class="form-group">
            ...
            <input type="url" v-model="formData.website" required />
          </div>
...
const servicesInput = computed({
  get: () => formData.value.services.join(', '),
  set: (val) => {
...
const saveOrder = async () => {
  ...
  try {
    const updatePromises = partners.value.map((item, index) => {
      item.order = index;
      return api.update('partners', item.id, { order: index });
    });
